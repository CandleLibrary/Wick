var wick = (function (exports) {
    ...
    */
     ...
     * @alias css
     */
    const CSSParser = (css_string, root = null) => (root = (!root || !(root instanceof CSSRootNode)) ? new CSSRootNode() : root, root.parse(whind$3(css_string)));
    ...
    */
    ...
    TOKEN_LENGTH_MASK$3 = 0xFFFFFFC0,
    ...
    class Lexer$3 {
        ...
        get token_length(){
            return ((this.masked_values & TOKEN_LENGTH_MASK$3) >> 6);
        }

        set token_length(value){
            this.masked_values = (this.masked_values & ~TOKEN_LENGTH_MASK$3) | (((value << 6) | 0) & TOKEN_LENGTH_MASK$3); 
        }
    ...
    */
    ...
    class CSS_Bezier$1 extends CBezier$1 {
    	static parse(l, rule, r) {
     ...
     * @alias css
     */
    const CSSParser$1 = (css_string, root = null) => (root = (!root || !(root instanceof CSSRootNode$1)) ? new CSSRootNode$1() : root, root.parse(whind$4(css_string)));
