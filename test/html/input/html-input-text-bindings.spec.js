...
assert_group("Text Input", browser, sequence, () => {
    ...
    const model = new wick.objects.Observable({ data: "test" });
    ...
    assert(model.data == "test2");
    assert(instance.ele.children[1].innerHTML == "yes");
});
