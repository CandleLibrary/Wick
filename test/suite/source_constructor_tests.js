...
<w-s schema="any" class="style">
    ...
    <div id="style" style="((style))" name="<w>((name))</w>">
...
<template id="my-input">
    <div style="((style))">((nameer)) This is my input</div>
        ...
        describe("Construction of Sources", function() {
            ...
            it('Constructs an AST on properly formatted HTML', function() {
                ...
                for (let i = 0; i < 10; i++) {
                    ...
                    let manager = $package.mount(element, Any, false);

                    document.body.appendChild(element);
                }
            })

            it.skip('Loads Cascading Style information into the local template scope', function() {
            ...
            it('Updates the DOM when a Model property changes.', function(done) {
            ...
            it('Updates element attributes when a Model property changes.', function(done) {
                this.timeout(0);
