const e = (tk, env, output, lex, prv_lex) => {            /*USED for ASI*/            if (env.ASI && lex.tx !== ")" && !lex.END) {                let ENCOUNTERED_NL = (lex.tx == "}" || lex.END);                while (!ENCOUNTERED_NL && !prv_lex.END && prv_lex.off < lex.off) {                    prv_lex.next();                    if (prv_lex.ty == prv_lex.types.nl)                        ENCOUNTERED_NL = true;                }            if (ENCOUNTERED_NL)                return ";";            }            if(lex.END)            return ";";            return null;        }, nf = ()=>-1, for_stmt=function(set,bool,iter, body){this.set = set; this.bool = bool, this.iter=iter, this.body = body},
...
defaultError=(tk, env, output, lex, prv_lex) => {            /*USED for ASI*/            if (env.ASI && lex.tx !== ")" && !lex.END) {                let ENCOUNTERED_NL = (lex.tx == "}" || lex.END);                while (!ENCOUNTERED_NL && !prv_lex.END && prv_lex.off < lex.off) {                    prv_lex.next();                    if (prv_lex.ty == prv_lex.types.nl)                        ENCOUNTERED_NL = true;                }            if (ENCOUNTERED_NL)                return ";";            }            if(lex.END)            return ";";            return null;        },
S$0=function (sym,env,lex,state) {return sym},
start$0=function (sym,env,lex,state) {return sym[0]},
statement_list$0=function (sym,env,lex,state) {return Array.isArray(sym[0]) ? (sym[0].push(sym[1]) , sym[0]) : [sym[0], sym[1]];},
...
(t, e, o, l, s)=>{let ln = Math.max(o.length-1,0); o[ln]=( start$0(o.slice(-1),e,l,s));o.length=ln+1;; return 22535},
(t, e, o, l, s)=>23559,
(t, e, o, l, s)=>24583,
...
(t, e, o, l, s)=>{let ln = Math.max(o.length-2,0); o[ln]=( statement_list$0(o.slice(-2),e,l,s));o.length=ln+1;; return 22539},
(t, e, o, l, s)=>966,
...
(t, e, o, l, s)=>1214,
(t, e, o, l, s)=>112647,
(t, e, o, l, s)=>{let ln = Math.max(o.length-1,0); o[ln]=( case_clauses$0(o.slice(-1),e,l,s));o.length=ln+1;; return 111623},
...
(t, e, o, l, s)=>1270,
(t, e, o, l, s)=>1274,
(t, e, o, l, s)=>{let ln = Math.max(o.length-1,0); o[ln]=( case_clauses$0(o.slice(-1),e,l,s));o.length=ln+1;; return 56327},
...
(t, e, o, l, s)=>1538,
(t, e, o, l, s)=>1542,
(t, e, o, l, s)=>{let ln = Math.max(o.length-1,0); o[ln]=( case_clauses$0(o.slice(-1),e,l,s));o.length=ln+1;; return 101383},
(t, e, o, l, s)=>102407,
...
(t, e, o, l, s)=>1582,
(t, e, o, l, s)=>1586,
(t, e, o, l, s)=>{let ln = Math.max(o.length-1,0); o[ln]=( case_clauses$0(o.slice(-1),e,l,s));o.length=ln+1;; return 98311},
(t, e, o, l, s)=>1594,
...
(t, e, o, l, s)=>{let ln = Math.max(o.length-3,0); o[ln]=( block$0(o.slice(-3),e,l,s));o.length=ln+1;; return 132111},
(t, e, o, l, s)=>1614,
(t, e, o, l, s)=>1618,
(t, e, o, l, s)=>1622,
(t, e, o, l, s)=>1626,
...
(t, e, o, l, s)=>82951,
(t, e, o, l, s)=>{let ln = Math.max(o.length-1,0); o[ln]=( case_clauses$0(o.slice(-1),e,l,s));o.length=ln+1;; return 83975},
(t, e, o, l, s)=>84999,
...
(t, e, o, l, s)=>1846,
(t, e, o, l, s)=>67591,
(t, e, o, l, s)=>{let ln = Math.max(o.length-1,0); o[ln]=( case_clauses$0(o.slice(-1),e,l,s));o.length=ln+1;; return 66567},
(t, e, o, l, s)=>68615,
...
(t, e, o, l, s)=>{let ln = Math.max(o.length-4,0); o[ln]=( block$0(o.slice(-4),e,l,s));o.length=ln+1;; return 132115},
...
(t, e, o, l, s)=>2382,
(t, e, o, l, s)=>2394,
(t, e, o, l, s)=>{let ln = Math.max(o.length-1,0); o[ln]=( case_clauses$0(o.slice(-1),e,l,s));o.length=ln+1;; return 44039},
(t, e, o, l, s)=>2402,
...
(t, e, o, l, s)=>{let ln = Math.max(o.length-2,0); o[ln]=( case_clauses$1(o.slice(-2),e,l,s));o.length=ln+1;; return 44043},
(t, e, o, l, s)=>2494,
(t, e, o, l, s)=>2498,
